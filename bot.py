...
# Support Group:@Star_Bot_Discussion
# Bots Channel: @STAR_BOTZ
...
async def VidWatermarkAdder(bot, cmd):
	...
	if (int(file_size) > 2097152000) and (Config.ALLOW_UPLOAD_TO_STREAMTAPE is True) and (Config.STREAMTAPE_API_USERNAME != "NoNeed") and (Config.STREAMTAPE_API_PASS != "NoNeed"):
		...
		try:
			...
			print(f"Error: {e}")
			await editable.edit("Sorry, Something went wrong!\n\nCan't Upload to Streamtape. You can report at [Support Group](https://t.me/Star_Bot_Discussion).")
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Star_Bot_Discussion).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Group](https://t.me/Star_Bot_Discussion).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
